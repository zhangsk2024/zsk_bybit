...
// category	false	string	產品類型. linear,inverse 當category不指定時, 默認是linear
// symbol	true	string	合約名稱
// interval	true	string	時間粒度. 1,3,5,15,30,60,120,240,360,720,D,M,W
// start	false	integer	開始時間戳 (毫秒)
// end	false	integer	結束時間戳 (毫秒)
// limit	false	integer	每頁數量限制. [1, 1000]. 默認: 200
// type MarketMarkPriceKlineReq struct{
...
// type MarketMarkPriceKlineAPI struct {
// 	client *PublicRestClient
// 	req    *MarketMarkPriceKlineReq
// }

// func (api *MarketMarkPriceKlineAPI) Category(category string) *MarketMarkPriceKlineAPI {
// 	api.req.Category = GetPointer(category)
// 	return api
// }

// func (api *MarketMarkPriceKlineAPI) Symbol(symbol string) *MarketMarkPriceKlineAPI {
// 	api.req.Symbol = GetPointer(symbol)
// 	return api
// }

// func (api *MarketMarkPriceKlineAPI) Interval(interval string) *MarketMarkPriceKlineAPI {
// 	api.req.Interval = GetPointer(interval)
// 	return api
// }

// func (api *MarketMarkPriceKlineAPI) Start(start int64) *MarketMarkPriceKlineAPI {
// 	api.req.Start = &start
// 	return api
// }

// func (api *MarketMarkPriceKlineAPI) End(end int64) *MarketMarkPriceKlineAPI {
// 	api.req.End = &end
// 	return api
// }

// func (api *MarketMarkPriceKlineAPI) Limit(limit int) *MarketMarkPriceKlineAPI {
// 	api.req.Limit = &limit
// 	return api
// }
